...
{
    public partial class TS_HCTCassettePort  : Form
    {
        #region Initial

        public TS_HCTCassettePort()
        {
            InitializeComponent();
        }
        ...
        public void Initial()
        {
            ...
            for (int i = 1; i < HCT_EFEM.CassetteCount + 1; i++)
            {
                cboCnt.Items.Add(i);
            }
        ...
        private void TS_HCTCassettePort_FormClosing(object sender, FormClosingEventArgs e)
        {
